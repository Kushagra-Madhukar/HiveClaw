...
impl TuiState {
    fn new(
        ...
        Self {
            ...
            lines: vec![TuiLine {
                role: "system",
                text: "RoboClaw Terminal UI ready. Enter to send, F1 help, F2 /agents, F3 /approvals, F4 /runs, Ctrl+C to quit.".into(),
            }],
            info: vec![
                "Shortcuts".into(),
                "F1 help".into(),
    ...
    fn render(&mut self, stdout: &mut std::io::Stdout) -> Result<(), String> {
        ...
        draw_box(stdout, 0, 0, cols, header_h, \" RoboClaw TUI \")?;
